...
import { getAssistant, getAssistantById, getAssistantCallLogs, updateVapiAssistant, uploadFilesToVapi, upsertAssistant } from '../controller/assistant.controller';
...
router.get('/get-assistant-call-logs',verifyToken,getAssistantCallLogs);
